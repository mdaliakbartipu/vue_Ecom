...
<div class="container">
    <div class="flex" >
        ...
        <div class="order-action flex-item-main" style="margin-top:2em">
                <div>
                <button id="deleteOrder" class="btn btn-sm btn-warning">Delete Order</button>
                <button id="back" class="btn btn-sm btn-info">Cancelled List</button>
                </div>
        </div>
    </div>
</div>
...
back.addEventListener('click', function(event){
        event.preventDefault;
        window.location.replace('/cancelled-order/');
