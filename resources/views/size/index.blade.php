...
<div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
                <a href="{{route('size.create')}}" class="btn btn-primary">Add new</a>
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <td> <a href="{{route('size.edit',$size->id)}}" style="margin-right:10px"><span class="glyphicon glyphicon-edit"></span>  </a>  
