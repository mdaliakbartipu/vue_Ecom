          ...
          <div class="row">
            ...
            @include('layouts.includes.msg') 
              ...
              <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('save-size-chart') }}">
                         @csrf

                 <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Design your size Chart</label>
                          <textarea name="chart" id="chart" class="summernote" cols="30" rows="10">
                              {{$info->size_chart??''}}
                          </textarea>
                        </div>
                       </div>
