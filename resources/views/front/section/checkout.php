                                ...
                                <form action="#">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-20">
                                            ...
                                            </select><div class="nice-select niceselect_option" tabindex="0"><span class="current">bangladesh</span><ul class="list"><li data-value="2" class="option selected">bangladesh</li><li data-value="3" class="option">Algeria</li><li data-value="4" class="option">Afghanistan</li><li data-value="5" class="option">Ghana</li><li data-value="6" class="option">Albania</li><li data-value="7" class="option">Bahrain</li><li data-value="8" class="option">Colombia</li><li data-value="9" class="option">Dominican Republic</li></ul></div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb-20">
                                                        <div class="select_form_select">
                                                            ...
                                                            <select class="niceselect_option" name="cuntry" id="countru_name" style="display: none;">
                                                                <option value="2">bangladesh</option>
                                                                <option value="3">Algeria</option>
                                                                <option value="4">Afghanistan</option>
                                                                <option value="5">Ghana</option>
