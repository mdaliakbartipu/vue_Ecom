   ...
   <div class="container">
     <div class="row">
       ...
       <div class="col-lg-4 col-md-4 bg-gray">
         ...
         <figure class="single_banner" style="background: url('<?= ASSETS ?>/img/8-bgclient.png'); width: 100%;background-repeat: no-repeat;background-size: cover;">
           <div class="owl-carousel owl-theme">
             <?php foreach ($testimonials as $testimonial) : ?>
               <div class="item gif  text-center">
                 <div class="gif_text">
                   <p class=" text-justify pt-3 pb-3 pl-4 pr-4 "><?= $testimonial->message ?></p>
                   <div class="profile_img float-left" style="margin-bottom: 2em">
