...
<span class="btn"><i class="fa fa-puzzle-piece"></i>  Embroidery &amp; Print</span>
<span class="btn"><i class="fa fa-play"></i>  Video</span>
<span class="btn"><i class="fa fa-thumb-tack"></i>  Article recommendation</span>
</div>
