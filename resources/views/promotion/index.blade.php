...
<div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
                <a href="{{route('promotion.create')}}" class="btn btn-primary">Add new</a>
              <div class="card">
        ...
        <td> 
                <img class="img-responsive img-thumbnail" src="{{ asset('front/assets/.uploads/promotions/'.$promotion->image) }}"  style="height: 50px; weight: 30px;" alt=""> 
                 ...
                 <td> <a href="{{route('promotion.edit',$promotion->id)}} "  style="margin-right:10px"><span class="glyphicon glyphicon-edit"></span>  </a>
                
             
                    
        <form id="delete-form-{{ $promotion->id }}" method="POST" action="{{ route('promotion.destroy',$promotion->id)}}" style="display: none;">
         {{ csrf_field() }}
         {{ method_field('DELETE') }}
        </form>
        <a 
