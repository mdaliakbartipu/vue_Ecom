     ...
     <div class="form-group">
        <label for="inputError" class="col-xs-12 col-sm-3 col-md-3 control-label"> Sleeve</label>
              ...
              @foreach($sleeves as $key=>$sleeve)
                  <label>
                          <input  type="checkbox" class="ace " name="sleeve" value="{{ $key+1 }}" <?=($product->sleeve == ($key+1))? "checked='checked'":'';?>>
                 ...
                 <div class="col-xs-12 col-sm-9">
                     <div class="checkbox">
                          @foreach($leglenghts as $key=>$leglength)
                            <label>
                  <input  type="checkbox" class="ace" name="leglength" value="{{ $key+1 }}" <?=($product->leglength==($key+1))?"checked='checked'":'';?> >
                          ...
                          <div class="col-xs-12 col-sm-9">
                                <div class="checkbox">
                                   @foreach($fits as $key=>$fit) 
                                    <label>
                                        <input  type="checkbox" class="ace" name="fit" value="{{ $key+1 }}" <?=($product->fit==($key+1))?"checked='checked'": '';?>>
