...
<br/> <br/> 
          ...
          <td> <a href="{{ route('sub-edit',$sub->id) }}" style="margin-right:10px"><span class="glyphicon glyphicon-edit"></span>  </a>  
                  
             
                    
        <form id="delete-form-{{ $sub->id }}" method="POST" action="{{ route('sub-delete',$sub->id)}}" style="display: none;">
         {{ csrf_field() }}
         {{ method_field('DELETE') }}
        </form>
        <a 
