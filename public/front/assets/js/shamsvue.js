...
Vue.component('first_lavel_comment', {
    data:function(){
        return {
            replies: [
                {
                    id:21,
                    by:"Athan",
                    date:"October 16, 2018 at 1:38 am",
...
<div class="comment_thumb">
    <img :src="'/some/path/image/'+comment.image" alt="">
</div>
    <div class="comment_content">
            <div class="comment_meta">
                <h5><a href="#">{{comment.by}}</a></h5>
...
<second_level_comment v-for="(reply,index) in this.replies" :reply="reply" :key="index"></second_level_comment>

</div>
    `
});

Vue.component('second_level_comment', {
    ...
    <div class="comment_thumb">
        <img :src="'some/path/'+reply.image" alt="">
    </div>
    <div class="comment_content">
        <div class="comment_meta">
            <h5><a href="#">{{reply.by}}</a></h5>
...
Vue.component('comment_box', {
    ...
    <div class="comments_box">
        ...
        <first_lavel_comment v-for="(comment,index) in this.comments" :comment="comment" :key="index"></first_lavel_comment>
    </div>
    `
})
